...
def create_absa_pipeline(default_model = True, model_name = 'absa/classifier-rest-0.2'):
    ...
    professor = absa.Professor(pattern_recognizer=absa.aux_models.BasicPatternRecognizer())     # Independent component that supervises and explains a model prediction.
...
def get_sentiments(reviews, all_aspects, default_model = True,
                   model_name = 'absa/classifier-rest-0.2', verbose = True):
    '''
